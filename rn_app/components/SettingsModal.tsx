      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            ...
            {renderNumberInput(
              'feed.subsequentPageSize',
              'Subsequent Page Size',
              5,
              20,
            )}
          </View>
          ...
          <View style={styles.section}>
            ...
            {renderNumberInput(
              'visibility.nativeThrottleMs',
              'Native Throttle (ms)',
              10,
              200,

            {renderNumberInput(
              'visibility.softPlayThreshold',
              'Soft Play Threshold (%)',
              10,
              50,

            {renderNumberInput(
              'visibility.hardPlayThreshold',
              'Hard Play Threshold (%)',
              30,
              80,
            )}
